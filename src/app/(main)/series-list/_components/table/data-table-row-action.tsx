...
export function DataTableRowActions<TData>({
  ...
  const series = SerieSchema.parse(row.original);

  const serieInfo = `Patient Code: ${series.patient_code}
Study ID: ${series.study_id}
Study UUID: ${series.study_uuid}
Serie ID: ${series.series_id}
Serie UUID: ${series.series_uuid}
Serie Name: ${series.series_name}
Serie Status: ${series.series_status}
  `;
